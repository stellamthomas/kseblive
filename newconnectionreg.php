  ...
  <label class="form-check-label" for="exampleRadios2" style="color: white;">
    Female
			    			...
			    			<div class="row">
			    				...
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			    						<input type="text" name="last_name" id="last_name" class="form-control input-sm" placeholder="Total Loads (Watts)">
			    					</div>
			    				</div>
			    			</div>
			    			...
			    			<div class="row">
			    				...
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			    						<input type="text" name="last_name" id="last_name" class="form-control input-sm" placeholder="Aadhar Number">
			    					</div>
			    				</div>
			    			</div>
    ...
    Upload any address proof [.pdf/.jpg/.doc] :
			    				...
			    				<input type="file" name="last_name" id="last_name" class="form-control input-sm" >
			    			</div>
