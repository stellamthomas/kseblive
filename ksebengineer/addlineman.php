       ...
       else
       {
        return false;
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Add Lineman</h1>
                    <p class="mb-4"></p>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body" >
                          ...
                          <form role="form" action="linemanreg.php" method="post" enctype="multipart/form-data" name="myform">
              			    			<div class="row">
              ...
              <span style="color: red;font-size: 14px" id="f3"></span>
                ...
                <label class="form-check-label" for="exampleRadios2" style="color: grey;">
                  ...
                  <span style="color: red;font-size: 14px" id="f7"></span>
  			    			...
  			    			<input type="submit" value="Add Lineman" class="btn btn-info btn-block" onclick="return checkNewconn()" >
