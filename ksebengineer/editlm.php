...
{ 
  ...
  $sql = "select * from tb_linemanreg inner join tb_login where tb_login.id=tb_linemanreg.loginid and tb_linemanreg.lmkey='".$_GET['t']."'";//echo $sql;exit;
       ...
       else
       {
        return false;
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Update KSEB Lineman</h1>
                    <p class="mb-4"></p>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body" >
                          ...
                          {  ?>
                          <form role="form" action="updatelinemanreg.php?t=<?php echo $_GET['t']; ?>" method="post" enctype="multipart/form-data">
              			    			<div class="row">
...
<span style="color: red;font-size: 14px" id="f6"></span>
                  ...
                  <span style="color: red;font-size: 14px" id="f7"></span>
  			    			...
  			    			<input type="submit" value="Update Lineman" class="btn btn-info btn-block" onclick="return checkNewconn()" >
