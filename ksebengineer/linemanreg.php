<?php
  ...
  while($row=mysqli_fetch_array($result))
  {
	...
	$sql2="insert into tb_linemanreg(lmkey,fname,lname,address,gender,phno,district,section,pincode,curdate,engid,loginid) values
	('".$engineerkey."','".$firstname."','".$lastname."','".$address."','".$gender."','".$phno."','".$dist."','".$section."','".$pin."','".$curdate."','".$_COOKIE['lkey']."','".$loginid."')";
  //echo $sql2;exit;
  ...
  if($ex1 && $ex2)
    ...
    echo "<SCRIPT type='text/javascript'>window.location.replace(\"linemanmail.php\");</SCRIPT>";
	}
	else
	{
