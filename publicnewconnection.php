...
<div class="row">
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			               				<select class="form-control" data-country="US" data-state="CA" name="rtncard">
			    				...
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			    						<input type="text" name="pnch" class="form-control input-sm" placeholder="Panchayat">
			    					</div>
			    				</div>
			    			</div>
							...
							<div class="row">
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			    						<input type="text" name="vlg" class="form-control input-sm" placeholder="Village">
			               				
			    					</div>
			    				</div>
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			    						<input type="text" name="ward"  class="form-control input-sm" placeholder="Ward">
			    					</div>
			    				</div>
			    			</div>
			    			...
			    			<div class="row">
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			               				<input type="text" name="hno" class="form-control input-sm" placeholder="House #">
			    					</div>
			    				</div>
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			    						<input type="text" name="tlk" class="form-control input-sm" placeholder="Taluk">
			    					</div>
			    				</div>
			    			</div>
