...
input[type=submit]:hover {
  background-color: #45a049;
   ...
   <h1 style="font-size: 25px;padding-top: 110px;margin-left: 780px;">Daily Wage Staff Registration</h1>
    <form action="/action_page.php" style="margin-top: 60px;">
        ...
        <input  class="textb" type="password" name="pass" placeholder="Password" style="margin-left: 620px;">
        <input  class="textb" type="password" name="conpass" placeholder="Confirm Password" style="margin-left: 0px;">

        <input class="sub"  type="submit" value="Register">
    </form>

    <div class="counter01" style="margin-top: 220px;">
