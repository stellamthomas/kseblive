...
.form-control:focus {
    ...
    border-color: #4ca746
                            ...
                            <form action="supplypayment.php?t=<?php echo $key; ?>" method="post">
<div class="padding">
    <div class="row">
            ...
            <div class="col-sm-8 col-md-6">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6"> <span>CREDIT/DEBIT CARD PAYMENT</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red"><b>Amount : 200 INR</b></font></div>
                    ...
                    <div class="card-body" style="height: 390px">
                        ...
                        <div class="form-group"> <a href="javascript:alert('Do you want to abort transaction ?');window.location.href = 'viewaddionalsupplystatus.php';">
