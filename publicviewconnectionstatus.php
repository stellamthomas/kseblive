        ...
        while ($row=mysqli_fetch_array($result))
              ...
              <tbody>
                <tr>
                  ...
                  <td><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModalCenter1">More
</button><td>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      while ($row=mysqli_fetch_array($result))
        ...
        <?php $conno=$row['conno']; if($conno!=NULL){?>  <br>
        <b><font color="green">Consumer Number : <?php echo $row['conno']; ?></b></font><br>
        <b><font color="green">Phone Number : <?php echo $row['phno']; ?></b></font><br>
        <img src="ksebengineer/paid.png" height="70px" width="60px"><?php }?><br>
...
<?php  if($status==5)  {?>  <a href="updateconnection.php?t=<?php echo $appid;?>"> <button type="button" class="btn btn-primary" >Update Details</button></a><?php  }  ?>
