<?php
  ...
  { 
    ...
    $sql = "select * from tb_bill where consumerno='".$conno."' order by id desc LIMIT 1"; //echo $sql;exit;
    $result = mysqli_query($conn,$sql);
    while ($row=mysqli_fetch_array($result))
    {
      $finalread = $row['finalread'];
    }
...
?>
    ...
    <script src="../validation/addnonbill.js"></script>
                <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body" >
                          ...
                          <form role="form" action="billregnoncontact.php" method="post" enctype="multipart/form-data" name="myform">
              			    			<div class="row">
                              ...
                              <div class="row">
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                  <div class="form-group">
                                          ...
                                          id='tot' onkeyup="totTravel()" value="<?php echo $finalread; ?>" readonly>
                  <span style="color: red;font-size: 14px" id="top2"></span>
                                  </div>
                                </div>
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                  <div class="form-group">
                                    <input type="text" name="finalread" class="form-control input-sm" placeholder="Final Reading - Upload By Consumer" id='tot1' readonly>
