  <section class="section section-top section-full">
      ...
      <!-- Content -->
      <div class="container"><h5 style="text-align: left;color: white;">Notifications</h5><marquee><h6 style="color: white;"> Customers please pay the bills for enjoying uninterrupted power supply. </h6></marquee>
    ...
    font-size: 25px;">
            ...
            <p class="text-center mb-0" data-toggle="animation" data-animation="fadeUp" data-animation-order="3" data-animation-trigger="load">
              <a href="custquickpay.php"  class="btn btn-outline-primary text-white">
                Quick Pay
              </a>
            </p>
