...
<head>
  ...
  <body>
    ...
    font-size: 25px;">
              Online Portal For All KSEB Services.
            </h1>
        ...
        <div class="row align-self-center">
          ...
          <div class="col-md">
            ...
            <ul class="list-unstyled list-inline text-md-right">
              KSEB, Ministry of Power,Government of Kerala.
            </ul>
        ...
        <div class="row align-items-center">
          <div class="col-md">
            ...
            <p class="text-white text-muted">
              <small>
                &copy; Copyright <span class="current-year"></span> Stella M Thomas. All rights reserved.
              </small>
            </p>
